...
export const mergedPRs: MergedPR[] = [
  ...
  },
  {
    ...
    stars: 1264,
    title: "feat(mmm): reject target values outside the likelihood support at build time",
    link: "https://github.com/pymc-labs/pymc-marketing/pull/2975",
    merged: "Sep 10, 2026",
  },
  {
    repo: "pymc-labs/pymc-marketing",
    stars: 1264,
    title: "ci: run notebook tests on mmm notebook changes",
    link: "https://github.com/pymc-labs/pymc-marketing/pull/2971",
    merged: "Sep 10, 2026",
  },
  {
    repo: "pymc-labs/pymc-marketing",
    stars: 1264,
    title: "docs(mmm): say that DataDerivedScaling reductions are signed",
    link: "https://github.com/pymc-labs/pymc-marketing/pull/2978",
    merged: "Sep 9, 2026",
  },
  {
    repo: "pymc-labs/pymc-marketing",
    stars: 1264,
    title: "ci: skip the LLM PR labeler on every fork PR",
    link: "https://github.com/pymc-labs/pymc-marketing/pull/2972",
    merged: "Sep 8, 2026",
  },
  {
    repo: "pymc-labs/pymc-marketing",
  ...
  },
  {
    ...
    stars: 1594,
    title: "fix: put the +1 inside the tie term of the online exchangeability p-value",
    link: "https://github.com/scikit-learn-contrib/MAPIE/pull/985",
    merged: "Sep 8, 2026",
  },
  {
    repo: "scikit-learn-contrib/MAPIE",
  ...
  },
  {
    ...
    stars: 114,
    title: "feat: add Salesforce NPSP integration",
    link: "https://github.com/deepset-ai/haystack-integrations/pull/547",
    merged: "Aug 27, 2026",
  },
];
...
export const philanthroPy = {
  ...
  stats: [
    ...
    { label: "PyPI downloads", value: "177/mo" },
    { label: "Stars", value: "11" },
    { label: "Contributors", value: "18" },
    { label: "Tests", value: "2,103" },
